...
function createReduceHelper(app, children) {
  return function (state, actions) {
    return Object.keys(actions).reduce(function (newState, child) {
      return _extends({}, newState, _defineProperty({}, child, actions[child].reduce(function (state, _ref2) {
        var _app$child;
        ...
        return children[child](state, (_app$child = app[child])[action].apply(_app$child, _toConsumableArray(args)));
      }, state[child])));
    }, {});
  };
}
