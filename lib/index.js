...
function createResetReducer(app, initialState, children) {
  ...
  return (0, _reduxActions.handleActions)(_defineProperty({}, app.reset, function () {
...
function reduceDucklings(ducklings, namespace, action, selector, reduce, app, children) {
...
function resolveDucklings(ducklings, namespace, action, selector, reduce, combinedApp, children) {
  ...
  var _reduceDucklings = reduceDucklings([resetAction].concat(_toConsumableArray(ducklings)), namespace, action, selector, reduce, combinedApp, children),
